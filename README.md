...
> [!WARNING]
> 本项目为个人开发的非官方同人衍生技术测试项目，完全免费。项目内所有角色头像及人设描述均由 AI 生成，不包含任何米哈游（miHoYo）官方美术素材或文本原件。所有音频素材版权均归米哈游（miHoYo）及相关配音演员所有，本项目仅作技术交流与非商业性个人研究，若版权方认为有所不妥，请联系本邮箱，将立刻配合删除相关素材。本项目与米哈游官方无任何商业合作或关联。
...
| 平台 | 支持状态 | 下载链接 | 备注 |
| :--- | :---: | :--- | :--- |
| 📱 **Android** | ✅ 支持 | [APK 下载](https://github.com/KaiXuan666/StarRailChatBox/releases/download/v1.1.0/StarRailChatBox_1.1.0.apk) | 已发布，运行稳定 |
| 💻 **Windows** | ✅ 支持 | [MSI 下载](https://github.com/KaiXuan666/StarRailChatBox/releases/download/v1.1.0/StarRailChatBox-1.1.0.msi) | 已发布，运行稳定 |
| 🍏 **iOS** | ⏳ 未来支持 | - | 规划中 |
...
<div align="center">
  ...
  <p>没有Api Key？点此获取：<a href="https://jeniya.top/register?channel=c_mcdvdrkp">https://jeniya.top</a></p>
</div>
